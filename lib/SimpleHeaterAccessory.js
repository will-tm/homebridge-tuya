        ...
        this.device.on('change', (changes, state) => {
            ...
            if (changes.hasOwnProperty(this.dpDesiredTemperature)) {
                if (characteristicCoolingThresholdTemperature.value !== changes[this.dpDesiredTemperature])
                    characteristicCoolingThresholdTemperature.updateValue(this._getDividedState(changes[this.dpDesiredTemperature], this.targetTemperatureDivisor));
            }
            ...
            // console.log('[Tuya] SimpleHeater changed: ' + JSON.stringify(changes));
